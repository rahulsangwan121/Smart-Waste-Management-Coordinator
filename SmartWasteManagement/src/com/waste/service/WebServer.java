...
public class WebServer {
    public static void startServer() throws IOException {
        // --- BADLAV 1: DYNAMIC PORT (Render ke liye zaroori) ---
        // Render apna port 'PORT' environment variable se deta hai.
    ...
    // --- BADLAV 2: OPTIONS/CORS HELPER ---
    // Browser aksar asli request se pehle 'OPTIONS' request bhejta hai check karne ke liye.
